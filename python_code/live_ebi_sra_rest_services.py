...
__credits__ = ["Doug Wendel", "Yoshiki Vazquez Baeza", "Adam Robbins-Pianka"]
__license__ = "GPL"
...
class LiveEBISRARestServices(BaseRestServices):
    ...
    def call_ascp_command_line(self, ascp_command, debug = False):
        ...
        # environment variable for ascp to have access to the credentials
        environ['ASPERA_SCP_PASS'] = self.ftp_pass
