...
script_info = {}
script_info['brief_description'] = "Run generate_mapping_and_otu_table in QIIME-DB python_code"
script_info['script_description'] = """\
This script takes input from the DB, then associates the appropriate files and
parameters to the generate_mapping_and_otu_table function from the QIIME-DB
"""
