...
# load the qiime_config and get qiime scripts directory
...
def write_mapping(data_access, table_col_value, fs_fp, web_fp, 
    ...
    """ This function will generate a mapping file from the QIIME-DB """
    
    # get temp filename for writing
    ...
    # get the url location of the directories listed above since they 
    # are based on the apache and not filesystem
    ...
    for row in results:
        ...
        # if the column is a controlled vocab, get the value associated to the 
        # vocab-id
    ...
    # iterate over all per-run-prefix mapping files, parsing each
