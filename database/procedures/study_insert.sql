...
(
  ...
  submit in varchar2,
  public_private in varchar2,
  stdy_id in out int
)
as
begin
  
  insert into study (study_id, project_name, investigation_type, study_complt_stat, "PUBLIC", submit_to_insdc)
  values (seq_study.nextval, study_name, investigation_type, study_completion_status, public_private, submit)
