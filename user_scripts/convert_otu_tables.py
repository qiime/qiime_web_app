        ...
        if processed_folder.startswith('processed'):
            ...
            if not exists(gg_biom_fp):
                ...
                if exists(gg_otu_table_fp):
                    ...
                    system("python /home/wwwuser/software/biom-format/scripts/convert_biom.py -i %s -o %s --biom_table_type='otu table'" % (gg_otu_table_fp,gg_biom_fp))
            try:
                system("python /home/wwwuser/software/Qiime_svn/scripts/add_taxa.py -i %s -t /home/wwwuser/phpr_taxonomy.txt -o %s" % (gg_biom_fp,gg_biom_fp))
            except:
                pass
